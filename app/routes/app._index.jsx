...
export default function Index() {
  ...
  console.log("listingData (SSR):", listingData.map((item) => ({
    id: item.id,
    _id: item._id
  })));
  return (
